    ...
    <div class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
            <div class="flex items-center px-5">
                ...
                <div class="ml-3">
                    <div class="text-base font-medium leading-none text-white">nathaniel Gil</div>
                    <div class="text-sm font-medium leading-none text-gray-400">gilnathaniel@gmail.com</div>
                </div>
                <button type="button"
